...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Grant Watson | Full Stack Developer</title>
        <meta name="description" content="Learn about Grant Watson, a Full Stack .NET Developer based in Georgia with experience in ASP.NET, ReactJS, Blazor, and government systems." />
        <meta property="og:title" content="About Grant Watson | Full Stack Developer" />
        <meta property="og:description" content="Full Stack .NET Developer with a background in government software development and a passion for clean, maintainable code." />
      </Helmet>
      <div className="about-container" style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <h1>About Me</h1>
        <p>
          Hi, I'm <strong>Grant Watson</strong> — a Full Stack .NET Developer based in Georgia. With a career that began in 2017, I've had the opportunity to build and support software for government agencies like the Department of Defense, Department of Commerce, and Cherokee Nation. I currently am a business programmer for Unum.
        </p>
        <p>
